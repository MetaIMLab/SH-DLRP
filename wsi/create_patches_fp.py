...
def seg_and_patch(source, save_dir, patch_save_dir, mask_save_dir, stitch_save_dir,
    ...
    for i in range(total):
        ...
        print("\n\nprogress: {:.2f}, {}/{}".format(i / total if total else 1.0, i, total))
...
parser.add_argument('--source', type=str, default="./dataset/wsi_raw/",
                    help='path to folder containing raw wsi_raw image files')
parser.add_argument('--step_size', type=int, default=256,
                    help='step_size')
parser.add_argument('--patch_size', type=int, default=256,
                    help='patch_size')
parser.add_argument('--patch', default=True, action=argparse.BooleanOptionalAction)
parser.add_argument('--seg', default=True, action=argparse.BooleanOptionalAction)
parser.add_argument('--stitch', default=True, action=argparse.BooleanOptionalAction)
parser.add_argument('--no_auto_skip', default=True, action='store_false')
parser.add_argument('--save_dir', type=str, default="./dataset/wsi_seg/",
