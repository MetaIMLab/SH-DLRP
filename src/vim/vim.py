...
@register_model
def vim_tiny_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2(resume, pretrained=False, **kwargs):
    model = VisionMamba(
...
if __name__ == '__main__':
    ...
    model = vim_tiny_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2(resume="../../pretrain_weights/vim_t_midclstok_76p1acc.pth", pretrained=True).to(device)
    out = model(x1)
    print(out.shape)
    ...
    #
    # model = MultiModalVisionTransformer(True, "../../pretrain_weights/jx_vit_base_patch16_224_in21k-e5005f0a.pth")
    #
